...
export const ARCameraFallbackOverlay: React.FC<ARCameraFallbackOverlayProps> = ({
  ...
  return (
    <div className="absolute inset-0 z-[76] bg-black pointer-events-auto">
      <video
        ref={videoRef}
      ...
      <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(0,0,0,0.35)_0%,rgba(0,0,0,0.15)_40%,rgba(0,0,0,0.45)_100%)]" />

      <div className="absolute top-3 left-1/2 -translate-x-1/2 w-[min(94vw,720px)] rounded-2xl border border-[#cfab91] bg-[#f7ecdd]/88 backdrop-blur-sm px-4 py-3 shadow-[0_20px_70px_rgba(0,0,0,0.45)]">
        <div className="flex items-start justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-xs sm:text-sm text-[#7f5b56]">
              Entrou no fallback por camera em {contextLabel}. O cenario 3D continua rodando por cima da imagem real.
            </p>
          </div>
      ...
      <div className="absolute bottom-3 left-1/2 -translate-x-1/2 w-[min(94vw,760px)] rounded-2xl border border-[#cfab91] bg-[#f7ecdd]/88 backdrop-blur-sm px-4 py-3 shadow-[0_20px_70px_rgba(0,0,0,0.45)]">
