...
export const ENEMY_DATA: EnemyTemplate[] = [
  {
    ...
    type: 'undead',
    enemyClassId: 'ranger',
    baseStats: { hp: 88, maxHp: 88, mp: 24, maxMp: 24, atk: 7, magic: 8, def: 4, speed: 3, luck: 2 },
    color: '#d6d3d1',
    scale: 1.02,
  ...
  },
  {
    ...
    type: 'undead',
    enemyClassId: 'rogue',
    baseStats: { hp: 88, maxHp: 88, mp: 24, maxMp: 24, atk: 9, magic: 6, def: 3, speed: 4, luck: 3 },
    color: '#cbd5e1',
    scale: 1.04,
  ...
  },
  {
    ...
    type: 'undead',
    enemyClassId: 'knight',
    baseStats: { hp: 110, maxHp: 110, mp: 18, maxMp: 18, atk: 12, magic: 6, def: 6, speed: 2, luck: 1 },
    color: '#e2e8f0',
    scale: 1.08,
  ...
  },
  {
    ...
    type: 'undead',
    enemyClassId: 'mage',
    baseStats: { hp: 68, maxHp: 68, mp: 40, maxMp: 40, atk: 5, magic: 12, def: 3, speed: 3, luck: 2 },
    color: '#c4b5fd',
    scale: 1.06,
