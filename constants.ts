...
const BASE_SHOP_ITEMS: Item[] = [
  ...
  // --- ARMOR (CHEST) ---
  { id: 'arm_b1', name: 'Túnica de Couro', description: 'Proteção básica. +4 DEF e +6 MP', cost: 180, type: 'armor', value: 4, mpBonus: 6, icon: '👕', iconImage: _armIcon('Túnica de Couro.png'), rarity: 'bronze', minLevel: 1 },
  { id: 'arm_b2', name: 'Gibão Reforçado', description: 'Costuras duplas para absorver impacto. +5 DEF', cost: 170, type: 'armor', value: 5, icon: '🦺', iconImage: _armIcon('Gibão Reforçado.png'), rarity: 'bronze', minLevel: 2 },
  { id: 'arm_b3', name: 'Peitoral de Ferro Cru', description: 'Placas simples de ferro batido. +6 DEF e +8 MP', cost: 260, type: 'armor', value: 6, mpBonus: 8, icon: '🥋', iconImage: _armIcon('Peitoral de Ferro Cru.png'), rarity: 'bronze', minLevel: 3 },
  { id: 'arm_s1', name: 'Cota de Malha', description: 'Elos de aço entrelaçados. +12 DEF e +16 MP', cost: 1200, type: 'armor', value: 12, mpBonus: 16, icon: '⛓️', iconImage: _armIcon('Cota de Malha.png'), rarity: 'silver', minLevel: 4 },
  { id: 'arm_s2', name: 'Armadura de Sentinela', description: 'Proteção estável para caçadas longas. +14 DEF', cost: 1450, type: 'armor', value: 14, icon: '🛡️', iconImage: _armIcon('Armadura de Sentinela.png'), rarity: 'silver', minLevel: 5 },
  { id: 'arm_s3', name: 'Couraça de Guarda Real', description: 'Aço lapidado para segurar ataques pesados. +16 DEF e +24 MP', cost: 1700, type: 'armor', value: 16, mpBonus: 24, icon: '🦾', iconImage: _armIcon('Couraça de Guarda Real.png'), rarity: 'silver', minLevel: 6 },
  { id: 'arm_g1', name: 'Peitoral Rúnico', description: 'Encantado com magia antiga. +30 DEF e +36 MP', cost: 3600, type: 'armor', value: 30, mpBonus: 36, icon: '🛡️', iconImage: _armIcon('Peitoral Rúnico.png'), rarity: 'gold', minLevel: 9 },
  { id: 'arm_g2', name: 'Armadura do Arconte', description: 'Placas místicas que anulam impacto bruto. +34 DEF e +42 MP', cost: 4200, type: 'armor', value: 34, mpBonus: 42, icon: '🏛️', iconImage: _armIcon('Armadura do Arconte.png'), rarity: 'gold', minLevel: 10 },
  { id: 'arm_g3', name: 'Bastião Imperial', description: 'Forjada para a linha de frente absoluta. +38 DEF e +50 MP', cost: 5000, type: 'armor', value: 38, mpBonus: 50, icon: '👑', iconImage: _armIcon('Bastião Imperial.png'), rarity: 'gold', minLevel: 12 },
  ...
  { id: 'hlm_s1', name: 'Elmo de Gladiador', description: 'Intimidador. +8 DEF e +30 HP', cost: 1200, type: 'helmet', value: 8, hpBonus: 30, icon: '🪖', iconImage: _hlmIcon('Elmo de Gladiador.png'), rarity: 'silver', minLevel: 5 },
  { id: 'hlm_s2', name: 'Visor de Aço Azul', description: 'Foco e proteção em lutas táticas. +10 DEF', cost: 1360, type: 'helmet', value: 10, icon: '🧲', iconImage: _hlmIcon('Visor de Aço Azul.png'), rarity: 'silver', minLevel: 6 },
  { id: 'hlm_s3', name: 'Elmo de Comandante', description: 'Projeto fechado para combates intensos. +11 DEF e +42 HP', cost: 1560, type: 'helmet', value: 11, hpBonus: 42, icon: '🛡️', iconImage: _hlmIcon('Elmo de Comandante.png'), rarity: 'silver', minLevel: 7 },
  { id: 'hlm_g1', name: 'Coroa do Rei Lich', description: 'Gelada ao toque. +20 DEF e +68 HP', cost: 3600, type: 'helmet', value: 20, hpBonus: 68, icon: '👑', iconImage: _hlmIcon('Coroa do Rei Lich.png'), rarity: 'gold', minLevel: 10 },
  { id: 'hlm_g2', name: 'Elmo do Eclipse', description: 'Canaliza energia para resistir a golpes críticos. +23 DEF', cost: 4100, type: 'helmet', value: 23, icon: '🌘', iconImage: _hlmIcon('Elmo do Eclipse.png'), rarity: 'gold', minLevel: 11 },
  { id: 'hlm_g3', name: 'Coroa de Aço Celeste', description: 'Proteção régia para mestres de guerra. +26 DEF e +90 HP', cost: 4700, type: 'helmet', value: 26, hpBonus: 90, icon: '✨', iconImage: _hlmIcon('Coroa de Aço Celeste.png'), rarity: 'gold', minLevel: 12 },
  ...
  { id: 'leg_b3', name: 'Grevas Curtas', description: 'Leves e ágeis para reposicionamento. +3 VEL', cost: 360, type: 'legs', value: 3, icon: '🥾', iconImage: _legIcon('Grevas Curtas.png'), rarity: 'bronze', minLevel: 3 },
  ...
  { id: 'leg_s2', name: 'Botas de Sentinela', description: 'Passo sólido e resposta rápida. +5 VEL', cost: 1950, type: 'legs', value: 5, icon: '🥾', iconImage: _legIcon('Botas de Sentinela.png'), rarity: 'silver', minLevel: 5 },
  ...
  { id: 'leg_g1', name: 'Grevas Dracônicas', description: 'Ligas raras para arrancadas explosivas. +7 VEL', cost: 4300, type: 'legs', value: 7, icon: '🐉', iconImage: _legIcon('Grevas Dracônicas.png'), rarity: 'gold', minLevel: 9 },
  { id: 'leg_g2', name: 'Botas do Guardião Solar', description: 'Impulso lendário com passada firme. +8 VEL', cost: 5600, type: 'legs', value: 8, icon: '☀️', iconImage: _legIcon('Botas do Guardião Solar.png'), rarity: 'gold', minLevel: 10 },
  { id: 'leg_g3', name: 'Passos do Colosso', description: 'Conjunto de elite para mobilidade máxima. +9 VEL', cost: 7200, type: 'legs', value: 9, icon: '🏛️', iconImage: _legIcon('Passos do Colosso.png'), rarity: 'gold', minLevel: 12 },
  ...
  { id: 'shd_s2', name: 'Escudo Bastião', description: 'Largo e estável contra ataques diretos. +12 DEF', cost: 1400, type: 'shield', value: 12, icon: '🧲', iconImage: _shdIcon('Escudo Bastião.png'), rarity: 'silver', minLevel: 6 },
  ...
  { id: 'shd_g1', name: 'Égide Sagrada', description: 'Reflete o mal. +25 DEF', cost: 3600, type: 'shield', value: 25, icon: '☀️', iconImage: _shdIcon('Égide Sagrada.png'), rarity: 'gold', minLevel: 9 },
  { id: 'shd_g2', name: 'Égide do Crepúsculo', description: 'Barreira mística para segurar explosões de dano. +28 DEF', cost: 4200, type: 'shield', value: 28, icon: '🌒', iconImage: _shdIcon('Égide do Crepúsculo.png'), rarity: 'gold', minLevel: 10 },
  { id: 'shd_g3', name: 'Escudo do Trono', description: 'Defesa suprema usada por campeões veteranos. +31 DEF', cost: 5000, type: 'shield', value: 31, icon: '👑', iconImage: _shdIcon('Escudo do Trono.png'), rarity: 'gold', minLevel: 12 },
];
