...
const BASE_SHOP_ITEMS: Item[] = [
  // --- POTIONS & CONSUMABLES ---
  { id: 'pot_1', name: 'Poção Menor', description: 'Cura ferimentos leves. +25 HP', cost: 40, type: 'potion', value: 25, icon: '🧪', iconImage: _itmIcon('Poção Menor.png'), rarity: 'bronze', minLevel: 1, animacaoExecucao: SPRITE_ANIMATION_IDS.execAuraVida2 },
  { id: 'pot_3', name: 'Poção de Vida', description: 'Recuperação moderada. +50 HP', cost: 70, type: 'potion', value: 50, icon: '❤️', iconImage: _itmIcon('Poção de Vida.png'), rarity: 'bronze', minLevel: 2, animacaoExecucao: SPRITE_ANIMATION_IDS.execAuraVida2 },
  { id: 'pot_5', name: 'Elixir Rubro', description: 'Cura poderosa. +100 HP', cost: 120, type: 'potion', value: 100, icon: '💖', iconImage: _itmIcon('Elixir Rubro .png'), rarity: 'silver', minLevel: 8, animacaoExecucao: SPRITE_ANIMATION_IDS.execAuraVida2 },
  { id: 'pot_4', name: 'Ambrosia Dourada', description: 'Restauração superior. +220 HP', cost: 300, type: 'potion', value: 220, icon: '🌟', iconImage: _itmIcon('Ambrosia Dourada.png'), rarity: 'gold', minLevel: 15, animacaoExecucao: SPRITE_ANIMATION_IDS.execAuraVida2 },

  { id: 'pot_2', name: 'Essência de Mana Menor', description: 'Recupera energia arcana. +20 MP', cost: 40, type: 'potion', value: 20, icon: '⚗️', iconImage: _itmIcon('Essência de Mana.png'), rarity: 'bronze', minLevel: 1, animacaoExecucao: SPRITE_ANIMATION_IDS.execAuraMana1 },
  { id: 'pot_mana_2', name: 'Tônico Arcano', description: 'Recuperação de mana intermediária. +45 MP', cost: 75, type: 'potion', value: 45, icon: '🔵', iconImage: _itmIcon('Tônico Arcano.png'), rarity: 'silver', minLevel: 3, animacaoExecucao: SPRITE_ANIMATION_IDS.execAuraMana1 },
  { id: 'pot_mana_3', name: 'Néctar Astral', description: 'Recuperação de mana avançada. +90 MP', cost: 140, type: 'potion', value: 90, icon: '🔷', iconImage: _itmIcon('Néctar Astral.png'), rarity: 'gold', minLevel: 6, animacaoExecucao: SPRITE_ANIMATION_IDS.execAuraMana1 },

  { id: 'pot_mix_1', name: 'Tônico Balanceado', description: 'Recupera 35 HP e 20 MP.', cost: 95, type: 'potion', value: 35, icon: '🧬', iconImage: _itmIcon('Tônico Balanceado.png'), rarity: 'silver', minLevel: 3, animacaoExecucao: SPRITE_ANIMATION_IDS.execAuraVida2 },
  { id: 'pot_mix_2', name: 'Elixir Dual', description: 'Recupera 80 HP e 50 MP.', cost: 190, type: 'potion', value: 80, icon: '💠', iconImage: _itmIcon('Elixir Dual.png'), rarity: 'gold', minLevel: 6, animacaoExecucao: SPRITE_ANIMATION_IDS.execAuraVida2 },
  ...
  // --- ARMOR (CHEST) ---
  { id: 'arm_b1', name: 'Túnica de Couro', description: 'Proteção básica. +3 D.MAG e +10 MP', cost: 180, type: 'armor', value: 0, mpBonus: 10, magicDefBonus: 3, icon: '👕', iconImage: _armIcon('Túnica de Couro.png'), rarity: 'bronze', minLevel: 1 },
  { id: 'arm_b2', name: 'Gibão Reforçado', description: 'Costuras duplas para absorver impacto. +3 DEF', cost: 170, type: 'armor', value: 3, icon: '🦺', iconImage: _armIcon('Gibão Reforçado.png'), rarity: 'bronze', minLevel: 2 },
  { id: 'arm_b3', name: 'Peitoral de Ferro Cru', description: 'Placas simples de ferro batido. +5 DEF', cost: 260, type: 'armor', value: 5, icon: '🥋', iconImage: _armIcon('Peitoral de Ferro Cru.png'), rarity: 'bronze', minLevel: 3 },
  { id: 'arm_s1', name: 'Cota de Malha', description: 'Elos de aço entrelaçados. +5 DEF e +16 MP', cost: 1200, type: 'armor', value: 5, mpBonus: 16, icon: '⛓️', iconImage: _armIcon('Cota de Malha.png'), rarity: 'silver', minLevel: 4 },
  { id: 'arm_s2', name: 'Armadura de Sentinela', description: 'Proteção estável para caçadas longas. +10 DEF', cost: 1450, type: 'armor', value: 10, icon: '🛡️', iconImage: _armIcon('Armadura de Sentinela.png'), rarity: 'silver', minLevel: 5 },
  { id: 'arm_s3', name: 'Couraça de Guarda Real', description: 'Aço lapidado para segurar ataques pesados. +6 DEF e +6 D.MAG', cost: 1700, type: 'armor', value: 6, magicDefBonus: 6, icon: '🦾', iconImage: _armIcon('Couraça de Guarda Real.png'), rarity: 'silver', minLevel: 6 },
  { id: 'arm_g1', name: 'Peitoral Rúnico', description: 'Encantado com magia antiga. +10 DEF e +30 MP', cost: 3600, type: 'armor', value: 10, mpBonus: 30, icon: '🛡️', iconImage: _armIcon('Peitoral Rúnico.png'), rarity: 'gold', minLevel: 9 },
  { id: 'arm_g2', name: 'Armadura do Arconte', description: 'Placas místicas que anulam impacto bruto. +12 D.MAG e +44 MP', cost: 4200, type: 'armor', value: 0, mpBonus: 44, magicDefBonus: 12, icon: '🏛️', iconImage: _armIcon('Armadura do Arconte.png'), rarity: 'gold', minLevel: 10 },
  { id: 'arm_g3', name: 'Bastião Imperial', description: 'Forjada para a linha de frente absoluta. +12 DEF e +10 D.MAG', cost: 5000, type: 'armor', value: 12, magicDefBonus: 10, icon: '👑', iconImage: _armIcon('Bastião Imperial.png'), rarity: 'gold', minLevel: 12 },

  // --- HELMETS ---
  { id: 'hlm_b1', name: 'Capuz de Viajante', description: 'Protege do sol. +2 DEF e +10 HP', cost: 150, type: 'helmet', value: 2, hpBonus: 10, icon: '🧢', iconImage: _hlmIcon('Capuz de Viajante.png'), rarity: 'bronze', minLevel: 1 },
  { id: 'hlm_b2', name: 'Elmo de Couro', description: 'Leve e firme para iniciantes. +3 DEF', cost: 150, type: 'helmet', value: 3, icon: '⛑️', iconImage: _hlmIcon('Elmo de Couro.png'), rarity: 'bronze', minLevel: 2 },
  { id: 'hlm_b3', name: 'Capacete de Vigia', description: 'Proteção frontal reforçada. +4 DEF e +16 HP', cost: 240, type: 'helmet', value: 4, hpBonus: 16, icon: '🪖', iconImage: _hlmIcon('Capacete de Vigia.png'), rarity: 'bronze', minLevel: 3 },
  { id: 'hlm_s1', name: 'Elmo de Gladiador', description: 'Intimidador. +6 DEF e +30 HP', cost: 1200, type: 'helmet', value: 6, hpBonus: 30, icon: '🪖', iconImage: _hlmIcon('Elmo de Gladiador.png'), rarity: 'silver', minLevel: 5 },
  { id: 'hlm_s2', name: 'Visor de Aço Azul', description: 'Foco e proteção em lutas táticas. +8 DEF e +5 D.MAG', cost: 1360, type: 'helmet', value: 8, magicDefBonus: 5, icon: '🧲', iconImage: _hlmIcon('Visor de Aço Azul.png'), rarity: 'silver', minLevel: 6 },
  { id: 'hlm_s3', name: 'Elmo de Comandante', description: 'Projeto fechado para combates intensos. +10 DEF e +42 HP', cost: 1560, type: 'helmet', value: 10, hpBonus: 42, icon: '🛡️', iconImage: _hlmIcon('Elmo de Comandante.png'), rarity: 'silver', minLevel: 7 },
  { id: 'hlm_g1', name: 'Coroa do Rei Lich', description: 'Gelada ao toque. +12 DEF e +58 HP', cost: 3600, type: 'helmet', value: 12, hpBonus: 58, icon: '👑', iconImage: _hlmIcon('Coroa do Rei Lich.png'), rarity: 'gold', minLevel: 10 },
  { id: 'hlm_g2', name: 'Elmo do Eclipse', description: 'Canaliza energia para resistir a golpes críticos. +12 DEF e +8 D.MAG', cost: 4100, type: 'helmet', value: 12, magicDefBonus: 8, icon: '🌘', iconImage: _hlmIcon('Elmo do Eclipse.png'), rarity: 'gold', minLevel: 11 },
  { id: 'hlm_g3', name: 'Coroa de Aço Celeste', description: 'Proteção régia para mestres de guerra. +14 D.MAG e +60 HP', cost: 4700, type: 'helmet', value: 0, hpBonus: 60, magicDefBonus: 14, icon: '✨', iconImage: _hlmIcon('Coroa de Aço Celeste.png'), rarity: 'gold', minLevel: 12 },
  ...
  { id: 'leg_b2', name: 'Botas de Couro', description: 'Firmes para marcha e esquiva. +2 VEL', cost: 260, type: 'legs', value: 2, icon: '👢', iconImage: _legIcon('Botas de Couro.png'), rarity: 'bronze', minLevel: 2 },
  { id: 'leg_b3', name: 'Grevas Curtas', description: 'Leves e ágeis para reposicionamento. +2 VEL e +1 SRT', cost: 360, type: 'legs', value: 2, luckBonus: 1, icon: '🥾', iconImage: _legIcon('Grevas Curtas.png'), rarity: 'bronze', minLevel: 3 },
  { id: 'leg_s1', name: 'Grevas de Ferro', description: 'Ajustadas para corrida de combate. +4 VEL', cost: 1500, type: 'legs', value: 4, icon: '👢', iconImage: _legIcon('Grevas de Ferro.png'), rarity: 'silver', minLevel: 4 },
  { id: 'leg_s2', name: 'Botas de Sentinela', description: 'Passo sólido e resposta rápida. +3 VEL e +2 SRT', cost: 1950, type: 'legs', value: 3, luckBonus: 2, icon: '🥾', iconImage: _legIcon('Botas de Sentinela.png'), rarity: 'silver', minLevel: 5 },
  { id: 'leg_s3', name: 'Grevas de Patrulha', description: 'Mobilidade avançada para lutas longas. +6 VEL', cost: 2450, type: 'legs', value: 6, icon: '🦿', iconImage: _legIcon('Grevas de Patrulha.png'), rarity: 'silver', minLevel: 6 },
  { id: 'leg_g1', name: 'Grevas Dracônicas', description: 'Ligas raras para arrancadas explosivas. +5 VEL e +5 SRT', cost: 4300, type: 'legs', value: 5, luckBonus: 5, icon: '🐉', iconImage: _legIcon('Grevas Dracônicas.png'), rarity: 'gold', minLevel: 9 },
  { id: 'leg_g2', name: 'Botas do Guardião Solar', description: 'Impulso lendário com passada firme. +10 VEL e +2 SRT', cost: 5600, type: 'legs', value: 10, luckBonus: 2, icon: '☀️', iconImage: _legIcon('Botas do Guardião Solar.png'), rarity: 'gold', minLevel: 10 },
  { id: 'leg_g3', name: 'Passos do Colosso', description: 'Conjunto de elite para mobilidade máxima. +14 VEL', cost: 7200, type: 'legs', value: 14, icon: '🏛️', iconImage: _legIcon('Passos do Colosso.png'), rarity: 'gold', minLevel: 12 },
  
  // --- SHIELDS ---
  { id: 'shd_b1', name: 'Tábua de Madeira', description: 'Melhor que nada. +3 DEF', cost: 140, type: 'shield', value: 3, icon: '🪵', iconImage: _shdIcon('Tábua de Madeira.png'), rarity: 'bronze', minLevel: 1 },
  { id: 'shd_b2', name: 'Broquel de Bronze', description: 'Escudo curto para defesas rápidas. +4 DEF', cost: 170, type: 'shield', value: 4, icon: '🛡️', iconImage: _shdIcon('Broquel de Bronze.png'), rarity: 'bronze', minLevel: 2 },
  { id: 'shd_b3', name: 'Escudo de Caravana', description: 'Modelo robusto usado em viagens longas. +5 DEF', cost: 240, type: 'shield', value: 5, icon: '🧱', iconImage: _shdIcon('Escudo de Caravana.png'), rarity: 'bronze', minLevel: 3 },
  { id: 'shd_s1', name: 'Escudo Torre', description: 'Uma parede móvel. +8 DEF', cost: 1200, type: 'shield', value: 8, icon: '🚪', iconImage: _shdIcon('Escudo Torre.png'), rarity: 'silver', minLevel: 5 },
  { id: 'shd_s2', name: 'Escudo Bastião', description: 'Largo e estável contra ataques diretos. +10 DEF', cost: 1400, type: 'shield', value: 10, icon: '🧲', iconImage: _shdIcon('Escudo Bastião.png'), rarity: 'silver', minLevel: 6 },
  { id: 'shd_s3', name: 'Escudo de Guerra', description: 'Estrutura reforçada para duelos brutais. +14 DEF', cost: 1650, type: 'shield', value: 14, icon: '⚔️', iconImage: _shdIcon('Escudo de Guerra.png'), rarity: 'silver', minLevel: 7 },
  { id: 'shd_g1', name: 'Égide Sagrada', description: 'Reflete o mal. +18 DEF', cost: 3600, type: 'shield', value: 18, icon: '☀️', iconImage: _shdIcon('Égide Sagrada.png'), rarity: 'gold', minLevel: 9 },
  { id: 'shd_g2', name: 'Égide do Crepúsculo', description: 'Barreira mística para segurar explosões de dano. +6 DEF e +16 D.MAG', cost: 4200, type: 'shield', value: 6, magicDefBonus: 16, icon: '🌒', iconImage: _shdIcon('Égide do Crepúsculo.png'), rarity: 'gold', minLevel: 10 },
  { id: 'shd_g3', name: 'Escudo do Trono', description: 'Defesa suprema usada por campeões veteranos. +14 DEF e +8 D.MAG', cost: 5000, type: 'shield', value: 14, magicDefBonus: 8, icon: '👑', iconImage: _shdIcon('Escudo do Trono.png'), rarity: 'gold', minLevel: 12 },
];
...
export const ENEMY_DATA: EnemyTemplate[] = [
  {
    ...
    type: 'undead',
    enemyClassId: 'ranger',
    baseStats: { hp: 88, maxHp: 88, mp: 24, maxMp: 24, atk: 16, magic: 14, def: 8, magicDef: 8, speed: 16, luck: 2 },
    color: '#d6d3d1',
    scale: 1.02,
  ...
  },
  {
    ...
    type: 'undead',
    enemyClassId: 'rogue',
    baseStats: { hp: 88, maxHp: 88, mp: 24, maxMp: 24, atk: 14, magic: 14, def: 6, magicDef: 8, speed: 20, luck: 3 },
    color: '#cbd5e1',
    scale: 1.04,
  ...
  },
  {
    ...
    type: 'undead',
    enemyClassId: 'knight',
    baseStats: { hp: 110, maxHp: 110, mp: 18, maxMp: 18, atk: 16, magic: 6, def: 8, magicDef: 6, speed: 12, luck: 1 },
    color: '#e2e8f0',
    scale: 1.08,
  ...
  },
  {
    ...
    type: 'undead',
    enemyClassId: 'mage',
    baseStats: { hp: 68, maxHp: 68, mp: 40, maxMp: 40, atk: 14, magic: 20, def: 3, magicDef: 16, speed: 16, luck: 2 },
    color: '#c4b5fd',
    scale: 1.06,
...
export const DUNGEON_ENEMY_DATA: DungeonEnemyTemplate[] = [
  ...
  { name: 'Crypt Warrior', type: 'undead', enemyClassId: 'barbarian', baseStats: { hp: 124, maxHp: 124, mp: 16, maxMp: 16, atk: 20, magic: 10, def: 6, magicDef: 3, speed: 8, luck: 1 }, minEvolution: 2, scale: 1.14, assets: createSkeletonAssets('Skeleton_Warrior.fbx', 2.2), attackStyle: 'unarmed', hpMultiplier: 1.2, atkMultiplier: 1.16, rareDrops: [{ itemId: 'pot_dg_elixir', chance: 0.12 }] },
