...
export const REGISTERED_WEAPON_3D_CATALOG: RegisteredWeapon3DDefinition[] = [
  createRegisteredWeapon({
    ...
    description: 'Versao simples e rapida para iniciantes. +3 ATK e +1 VEL',
    cost: 200,
    value: 3,
    speedBonus: 1,
    rarity: 'bronze',
  ...
  createRegisteredWeapon({
    ...
    description: 'Lamina curta refinada para golpes mais letais. +12 ATK',
    cost: 980,
    value: 12,
    rarity: 'silver',
    minLevel: 3,
  ...
  createRegisteredWeapon({
    ...
    description: 'Espada reta de entrada para combates simples. +4 ATK',
    cost: 320,
    value: 4,
    rarity: 'bronze',
    minLevel: 2,
  ...
  createRegisteredWeapon({
    ...
    description: 'Aco melhor balanceado e mais seguro no impacto. +14 ATK',
    cost: 1380,
    value: 14,
    rarity: 'silver',
    minLevel: 4,
  ...
  createRegisteredWeapon({
    id: 'wep_3d_sword_c',
    name: 'Espada Nobre C',
    description: 'Lamina mais longa com corte de elite. +16 ATK e +6 MAG',
    cost: 2880,
    value: 16,
    magicBonus: 6,
    rarity: 'gold',
  ...
  createRegisteredWeapon({
    id: 'wep_3d_sword_d',
    name: 'Espada Regia D',
    description: 'Forja superior com alcance e impacto ampliados. +18 ATK e +8 MAG',
    cost: 4360,
    value: 18,
    magicBonus: 8,
    rarity: 'gold',
  ...
  createRegisteredWeapon({
    ...
    description: 'Versao mais poderosa da linha de espadas. +20 ATK e +16 MAG',
    cost: 6200,
    value: 20,
    magicBonus: 16,
    rarity: 'gold',
  ...
  createRegisteredWeapon({
    ...
    description: 'A mais simples da linha, mas ainda brutal. +6 ATK',
    cost: 420,
    value: 6,
    rarity: 'bronze',
    minLevel: 2,
  ...
  createRegisteredWeapon({
    ...
    description: 'Cabeca de corte mais larga e mais pesada. +16 ATK',
    cost: 1820,
    value: 16,
    rarity: 'silver',
    minLevel: 5,
  ...
  createRegisteredWeapon({
    ...
    description: 'Versao superior para romper linhas pesadas. +22 ATK',
    cost: 3920,
    value: 22,
    rarity: 'gold',
    minLevel: 7,
  ...
  createRegisteredWeapon({
    ...
    description: 'Modelo simples, pesado e resistente. +10 ATK',
    cost: 700,
    value: 10,
    rarity: 'bronze',
    minLevel: 3,
  ...
  createRegisteredWeapon({
    ...
    description: 'Mais massa de impacto para quebrar defesas. +18 ATK',
    cost: 2280,
    value: 18,
    rarity: 'silver',
    minLevel: 5,
  ...
  createRegisteredWeapon({
    ...
    description: 'A melhor variante da linha de martelos. +28 ATK',
    cost: 4820,
    value: 28,
    rarity: 'gold',
    minLevel: 8,
  ...
  createRegisteredWeapon({
    ...
    description: 'Foco simples para usuarios de magia. +7 MAG',
    cost: 460,
    value: 0,
    magicBonus: 7,
    rarity: 'bronze',
  ...
  createRegisteredWeapon({
    ...
    description: 'Cajado simples para canalizacao basica. +3 ATK e +10 MAG',
    cost: 860,
    value: 3,
    magicBonus: 10,
    rarity: 'bronze',
  ...
  createRegisteredWeapon({
    ...
    description: 'Canalizador melhorado para magia pesada. +8 ATK e +14 MAG',
    cost: 3260,
    value: 8,
    magicBonus: 14,
    rarity: 'gold',
  ...
  createRegisteredWeapon({
    ...
    description: 'Perfura e controla a media distancia. +14 ATK e +6 MAG',
    cost: 2520,
    value: 14,
    magicBonus: 6,
    rarity: 'silver',
  ...
  createRegisteredWeapon({
    ...
    description: 'Arma de haste superior com corte e perfuracao. +16 ATK e +12 MAG',
    cost: 5400,
    value: 16,
    magicBonus: 12,
    rarity: 'gold',
  ...
  createRegisteredWeapon({
    id: 'wep_3d_bow_a',
    name: 'Arco Curto A',
    description: 'Arco simples para ataques precisos a distancia. +5 ATK e +2 VEL',
    cost: 520,
    value: 5,
    speedBonus: 2,
    rarity: 'bronze',
  ...
  createRegisteredWeapon({
    ...
    description: 'Arco mais forte e com melhor tensao. +14 ATK e +3 VEL',
    cost: 2050,
    value: 14,
    speedBonus: 3,
    rarity: 'silver',
  ...
  createRegisteredWeapon({
    ...
    description: 'Arma de punho simples para combate rapido. +6 ATK e +2 VEL',
    cost: 560,
    value: 6,
    speedBonus: 2,
    rarity: 'bronze',
  ...
  createRegisteredWeapon({
    ...
    description: 'Versao simples com massa adicional para o punho. +8 ATK e +3 VEL',
    cost: 1120,
    value: 8,
    speedBonus: 3,
    rarity: 'silver',
  ...
  createRegisteredWeapon({
    ...
    description: 'Arma de punho melhorada para pressao continua. +10 ATK e +3 VEL',
    cost: 1580,
    value: 10,
    speedBonus: 3,
    rarity: 'silver',
  ...
  createRegisteredWeapon({
    ...
    description: 'Versao empilhada para impacto brutal. +12 ATK e +5 VEL',
    cost: 3580,
    value: 12,
    speedBonus: 5,
    rarity: 'gold',
