...
export const GLTF_MONSTER_BESTIARY: GltfMonsterTemplate[] = [
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    baseStats: { hp: 29, maxHp: 29, mp: 0,  maxMp: 0,  atk: 5, def: 2, speed: 5, luck: 2, magic: 2 },
  ...
  },
  {
    ...
    baseStats: { hp: 35, maxHp: 35, mp: 12, maxMp: 12, atk: 4, def: 3, speed: 3, luck: 2, magic: 5 },
  ...
  },
  {
    ...
    baseStats: { hp: 46, maxHp: 46, mp: 0,  maxMp: 0,  atk: 7, def: 4, speed: 2, luck: 1, magic: 3 },
  ...
  },
  {
    ...
    baseStats: { hp: 25, maxHp: 25, mp: 15, maxMp: 15, atk: 3, def: 2, speed: 4, luck: 3, magic: 6 },
  ...
  },
  {
    ...
    baseStats: { hp: 39, maxHp: 39, mp: 20, maxMp: 20, atk: 5, def: 3, speed: 4, luck: 3, magic: 8 },
  ...
  },
  {
    ...
    baseStats: { hp: 32, maxHp: 32, mp: 10, maxMp: 10, atk: 6, def: 2, speed: 3, luck: 2, magic: 5 },
  ...
  },
  {
    ...
    baseStats: { hp: 22, maxHp: 22, mp: 8,  maxMp: 8,  atk: 3, def: 2, speed: 5, luck: 3, magic: 3 },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    baseStats: { hp: 34, maxHp: 34, mp: 0,  maxMp: 0,  atk: 5, def: 3, speed: 4, luck: 2, magic: 1 },
  ...
  },
  {
    ...
    baseStats: { hp: 42, maxHp: 42, mp: 18, maxMp: 18, atk: 4, def: 4, speed: 2, luck: 2, magic: 6 },
  ...
  },
  {
    ...
    baseStats: { hp: 36, maxHp: 36, mp: 6,  maxMp: 6,  atk: 6, def: 3, speed: 4, luck: 3, magic: 2 },
  ...
  },
  {
    ...
    baseStats: { hp: 43, maxHp: 43, mp: 0,  maxMp: 0,  atk: 7, def: 3, speed: 3, luck: 1, magic: 2 },
  ...
  },
  {
    ...
    baseStats: { hp: 41, maxHp: 41, mp: 4,  maxMp: 4,  atk: 7, def: 4, speed: 2, luck: 1, magic: 2 },
  ...
  },
  {
    ...
    baseStats: { hp: 32, maxHp: 32, mp: 8,  maxMp: 8,  atk: 5, def: 5, speed: 2, luck: 1, magic: 3 },
  ...
  },
  {
    ...
    baseStats: { hp: 43, maxHp: 43, mp: 12, maxMp: 12, atk: 6, def: 6, speed: 2, luck: 1, magic: 4 },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    baseStats: { hp: 39, maxHp: 39, mp: 16, maxMp: 16, atk: 8, def: 3, speed: 3, luck: 2, magic: 7 },
  ...
  },
  {
    ...
    baseStats: { hp: 34, maxHp: 34, mp: 22, maxMp: 22, atk: 6, def: 2, speed: 3, luck: 3, magic: 9 },
  ...
  },
  {
    ...
    baseStats: { hp: 31, maxHp: 31, mp: 0,  maxMp: 0,  atk: 6, def: 4, speed: 2, luck: 2, magic: 4 },
  ...
  },
  {
    ...
    baseStats: { hp: 36, maxHp: 36, mp: 20, maxMp: 20, atk: 7, def: 2, speed: 4, luck: 2, magic: 8 },
  ...
  },
  {
    ...
    baseStats: { hp: 49, maxHp: 49, mp: 18, maxMp: 18, atk: 8, def: 4, speed: 3, luck: 2, magic: 8 },
  ...
  },
  {
    ...
    baseStats: { hp: 56, maxHp: 56, mp: 24, maxMp: 24, atk: 10, def: 5, speed: 3, luck: 2, magic: 10 },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    baseStats: { hp: 28, maxHp: 28, mp: 6,  maxMp: 6,  atk: 5, def: 2, speed: 6, luck: 4, magic: 3 },
  ...
  },
  {
    ...
    baseStats: { hp: 32, maxHp: 32, mp: 8,  maxMp: 8,  atk: 5, def: 3, speed: 5, luck: 3, magic: 3 },
  ...
  },
  {
    ...
    baseStats: { hp: 42, maxHp: 42, mp: 14, maxMp: 14, atk: 6, def: 4, speed: 5, luck: 3, magic: 5 },
  ...
  },
  {
    ...
    baseStats: { hp: 27, maxHp: 27, mp: 0,  maxMp: 0,  atk: 6, def: 3, speed: 6, luck: 3, magic: 2 },
  ...
  },
  {
    ...
    baseStats: { hp: 39, maxHp: 39, mp: 10, maxMp: 10, atk: 7, def: 4, speed: 5, luck: 3, magic: 4 },
  ...
  },
  {
    ...
    baseStats: { hp: 25, maxHp: 25, mp: 12, maxMp: 12, atk: 4, def: 1, speed: 7, luck: 5, magic: 5 },
  ...
  },
  {
    ...
    baseStats: { hp: 31, maxHp: 31, mp: 20, maxMp: 20, atk: 4, def: 2, speed: 5, luck: 4, magic: 7 },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    baseStats: { hp: 35, maxHp: 35, mp: 18, maxMp: 18, atk: 6, def: 3, speed: 4, luck: 2, magic: 8 },
  ...
  },
  {
    ...
    baseStats: { hp: 31, maxHp: 31, mp: 12, maxMp: 12, atk: 7, def: 2, speed: 6, luck: 5, magic: 4 },
  ...
  },
  {
    ...
    baseStats: { hp: 39, maxHp: 39, mp: 8,  maxMp: 8,  atk: 7, def: 3, speed: 3, luck: 2, magic: 5 },
  ...
  },
  {
    ...
    baseStats: { hp: 34, maxHp: 34, mp: 22, maxMp: 22, atk: 5, def: 2, speed: 3, luck: 3, magic: 8 },
  ...
  },
  {
    ...
    baseStats: { hp: 25, maxHp: 25, mp: 20, maxMp: 20, atk: 4, def: 1, speed: 5, luck: 4, magic: 8 },
  ...
  },
  {
    ...
    baseStats: { hp: 28, maxHp: 28, mp: 24, maxMp: 24, atk: 5, def: 1, speed: 4, luck: 3, magic: 9 },
