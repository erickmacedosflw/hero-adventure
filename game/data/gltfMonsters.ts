...
export const GLTF_MONSTER_BESTIARY: GltfMonsterTemplate[] = [
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    baseStats: { hp: 23, maxHp: 23, mp: 0,  maxMp: 0,  atk: 3, def: 2, speed: 5, luck: 2, magic: 1 },
  ...
  },
  {
    ...
    baseStats: { hp: 28, maxHp: 28, mp: 12, maxMp: 12, atk: 2, def: 3, speed: 3, luck: 2, magic: 3 },
  ...
  },
  {
    ...
    baseStats: { hp: 36, maxHp: 36, mp: 0,  maxMp: 0,  atk: 4, def: 4, speed: 2, luck: 1, magic: 2 },
  ...
  },
  {
    ...
    baseStats: { hp: 20, maxHp: 20, mp: 15, maxMp: 15, atk: 2, def: 2, speed: 4, luck: 3, magic: 4 },
  ...
  },
  {
    ...
    baseStats: { hp: 31, maxHp: 31, mp: 20, maxMp: 20, atk: 3, def: 3, speed: 4, luck: 3, magic: 5 },
  ...
  },
  {
    ...
    baseStats: { hp: 25, maxHp: 25, mp: 10, maxMp: 10, atk: 4, def: 2, speed: 3, luck: 2, magic: 3 },
  ...
  },
  {
    ...
    baseStats: { hp: 17, maxHp: 17, mp: 8,  maxMp: 8,  atk: 2, def: 2, speed: 5, luck: 3, magic: 2 },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    baseStats: { hp: 27, maxHp: 27, mp: 0,  maxMp: 0,  atk: 3, def: 3, speed: 4, luck: 2, magic: 1 },
  ...
  },
  {
    ...
    baseStats: { hp: 33, maxHp: 33, mp: 18, maxMp: 18, atk: 2, def: 4, speed: 2, luck: 2, magic: 4 },
  ...
  },
  {
    ...
    baseStats: { hp: 28, maxHp: 28, mp: 6,  maxMp: 6,  atk: 4, def: 3, speed: 4, luck: 3, magic: 1 },
  ...
  },
  {
    ...
    baseStats: { hp: 34, maxHp: 34, mp: 0,  maxMp: 0,  atk: 4, def: 3, speed: 3, luck: 1, magic: 1 },
  ...
  },
  {
    ...
    baseStats: { hp: 32, maxHp: 32, mp: 4,  maxMp: 4,  atk: 4, def: 4, speed: 2, luck: 1, magic: 1 },
  ...
  },
  {
    ...
    baseStats: { hp: 25, maxHp: 25, mp: 8,  maxMp: 8,  atk: 3, def: 5, speed: 2, luck: 1, magic: 2 },
  ...
  },
  {
    ...
    baseStats: { hp: 34, maxHp: 34, mp: 12, maxMp: 12, atk: 4, def: 6, speed: 2, luck: 1, magic: 2 },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    baseStats: { hp: 31, maxHp: 31, mp: 16, maxMp: 16, atk: 5, def: 3, speed: 3, luck: 2, magic: 4 },
  ...
  },
  {
    ...
    baseStats: { hp: 27, maxHp: 27, mp: 22, maxMp: 22, atk: 4, def: 2, speed: 3, luck: 3, magic: 6 },
  ...
  },
  {
    ...
    baseStats: { hp: 24, maxHp: 24, mp: 0,  maxMp: 0,  atk: 4, def: 4, speed: 2, luck: 2, magic: 2 },
  ...
  },
  {
    ...
    baseStats: { hp: 28, maxHp: 28, mp: 20, maxMp: 20, atk: 4, def: 2, speed: 4, luck: 2, magic: 5 },
  ...
  },
  {
    ...
    baseStats: { hp: 39, maxHp: 39, mp: 18, maxMp: 18, atk: 5, def: 4, speed: 3, luck: 2, magic: 5 },
  ...
  },
  {
    ...
    baseStats: { hp: 44, maxHp: 44, mp: 24, maxMp: 24, atk: 7, def: 5, speed: 3, luck: 2, magic: 7 },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    baseStats: { hp: 22, maxHp: 22, mp: 6,  maxMp: 6,  atk: 3, def: 2, speed: 6, luck: 4, magic: 2 },
  ...
  },
  {
    ...
    baseStats: { hp: 25, maxHp: 25, mp: 8,  maxMp: 8,  atk: 3, def: 3, speed: 5, luck: 3, magic: 2 },
  ...
  },
  {
    ...
    baseStats: { hp: 33, maxHp: 33, mp: 14, maxMp: 14, atk: 4, def: 4, speed: 5, luck: 3, magic: 3 },
  ...
  },
  {
    ...
    baseStats: { hp: 21, maxHp: 21, mp: 0,  maxMp: 0,  atk: 4, def: 3, speed: 6, luck: 3, magic: 1 },
  ...
  },
  {
    ...
    baseStats: { hp: 31, maxHp: 31, mp: 10, maxMp: 10, atk: 4, def: 4, speed: 5, luck: 3, magic: 2 },
  ...
  },
  {
    ...
    baseStats: { hp: 20, maxHp: 20, mp: 12, maxMp: 12, atk: 2, def: 1, speed: 7, luck: 5, magic: 3 },
  ...
  },
  {
    ...
    baseStats: { hp: 24, maxHp: 24, mp: 20, maxMp: 20, atk: 2, def: 2, speed: 5, luck: 4, magic: 4 },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    baseStats: { hp: 28, maxHp: 28, mp: 18, maxMp: 18, atk: 4, def: 3, speed: 4, luck: 2, magic: 5 },
  ...
  },
  {
    ...
    baseStats: { hp: 24, maxHp: 24, mp: 12, maxMp: 12, atk: 4, def: 2, speed: 6, luck: 5, magic: 2 },
  ...
  },
  {
    ...
    baseStats: { hp: 31, maxHp: 31, mp: 8,  maxMp: 8,  atk: 4, def: 3, speed: 3, luck: 2, magic: 3 },
  ...
  },
  {
    ...
    baseStats: { hp: 27, maxHp: 27, mp: 22, maxMp: 22, atk: 3, def: 2, speed: 3, luck: 3, magic: 5 },
  ...
  },
  {
    ...
    baseStats: { hp: 20, maxHp: 20, mp: 20, maxMp: 20, atk: 2, def: 1, speed: 5, luck: 4, magic: 5 },
  ...
  },
  {
    ...
    baseStats: { hp: 22, maxHp: 22, mp: 24, maxMp: 24, atk: 3, def: 1, speed: 4, luck: 3, magic: 6 },
